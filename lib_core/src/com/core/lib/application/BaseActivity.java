...
public class BaseActivity extends FragmentActivity {
	...
	public void startActivityForResult(Intent intent,int requestCode, boolean needAnim) {
	...
	public void startActivityForResultAnim(Intent intent,int requestCode, int resAnimEnter,
			int resAnimExit) {
		if (intent != null) {
			startActivityForResult(intent, requestCode);
			overridePendingTransition(resAnimEnter, resAnimExit);
