...
public class WheelView extends View {
     ...
     */
    private static final String VALUE_TEXT_COLOR = "#39CDDA";

    /**
     * Items text color
     */
    private static final String ITEMS_TEXT_COLOR = "#5b5c5c";
...
//			0x00AAAAAA, 0x00AAAAAA };
     ...
     */
    private static final int ADDITIONAL_ITEM_HEIGHT = 15;// default 15
     ...
     */
    private static final int ADDITIONAL_ITEMS_SPACE = 10;//10
    ...
    //item
    private String itemColor = "#5b5c5c";
    private String itemCurrentColor = "#39CDDA";
    private int defaultItemHeight = ADDITIONAL_ITEM_HEIGHT;
    private int defaultItemWidht = ADDITIONAL_ITEMS_SPACE;
    private int itemTextSize;
    private int cacheItem;
    ...
    private void initResourcesIfNecessary() {
        ...
        if (centerDrawable == null) {
            centerDrawable = getContext().getResources().getDrawable(
                    R.drawable.wheel_middle);
            centerDrawable.setAlpha(50);
        }
...
//		}
    ...
    public void setCacheItem(int cacheItem) {
    ...
    private int calculateLayoutWidth(int widthSize, int mode) {
        ...
        itemsWidth += defaultItemWidht; // make it some more
...
//	}
    ...
    private void drawValue(Canvas canvas) {
        valuePaint.setColor(Color.parseColor(itemCurrentColor));
    ...
    private void drawItems(Canvas canvas) {
        ...
        itemsPaint.setColor(Color.parseColor(itemColor));
    ...
    public String getItemCurrentColor() {
        return itemCurrentColor;
    }

    public void setItemCurrentColor(String itemCurrentColor) {
        this.itemCurrentColor = itemCurrentColor;
        invalidate();
    }
    ...
    public int getDefaultItemWidht() {
        return defaultItemWidht;
    }

    public void setDefaultItemWidht(int defaultItemWidht) {
        this.defaultItemWidht = defaultItemWidht;
        invalidate();
    }
