...
public class WaveView extends View {
	...
	private final int default_blow_wave_alpha = 200;
	private final int default_above_wave_color = Color.TRANSPARENT;
	private final int default_blow_wave_color = Color.TRANSPARENT;
	...
	public void setBillColor(int progress) { // 根据进度改变颜色
//		if (progress == 0) {
//			blowWaveColor = getResources().getColor(R.color.red);
//			aboveWaveColor = getResources().getColor(R.color.red);
//		} else if (progress == 1) {
//			blowWaveColor = getResources().getColor(R.color.yellow);
//			aboveWaveColor = getResources().getColor(R.color.yellow);
//		} else {
			blowWaveColor = progress;
			aboveWaveColor = getResources().getColor(android.R.color.transparent);
//		}
...
//		aboveWavePath.lineTo(getRight(), getHeight());
	...
	public void setYZoom(int _y_zoom) {
		this.y_zoom = _y_zoom;
	}
