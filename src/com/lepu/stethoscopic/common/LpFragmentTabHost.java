package com.lepu.stethoscopic.common;
...
public class LpFragmentTabHost extends TabHost implements
    ...
    public LpFragmentTabHost(Context context) {
    ...
    public LpFragmentTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
